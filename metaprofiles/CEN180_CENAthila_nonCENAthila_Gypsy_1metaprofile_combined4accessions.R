...
scale_x_discrete(breaks = c(1,
                            ((upstream-1000)/binSize)+1,
                            (dim(summaryDFfeature_log2ChIP[[2]])[1]/length(log2ChIPPlaceholder))-((downstream-1000)/binSize),
...
scale_x_discrete(breaks = c(1,
                            ((upstream-1000)/binSize)+1,
                            (dim(summaryDFfeature_ChIP[[2]])[1]/length(ChIPPlaceholder))-((downstream-1000)/binSize),
...
scale_x_discrete(breaks = c(1,
                            ((upstream-1000)/binSize)+1,
                            (dim(summaryDFfeature_control[[2]])[1]/length(controlPlaceholder))-((downstream-1000)/binSize),
