...
# ./CEN180_CENAthila_nonCENAthila_Gypsy_1metaprofile.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 '2kb' 10 10 10bp 10bp '0.02,0.96' 'Col-0_CENH3_PE150_Rep1_ChIP' 'Col-0_CENH3_PE150_Rep1_input' 'CENH3_PE150_mn359_20220420/snakemake_ChIPseq_Col-0.ragtag_scaffolds' 'CENH3_PE150_mn359_20220420/snakemake_ChIPseq_Col-0.ragtag_scaffolds' 'Col-0 CENH3' 'Col-0 input' 'darkorange1' 'grey10' 'Col-0.ragtag_scaffolds'
# conda deactivate
...
#                                   split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col-0 CENH3,Cvi-0 CENH3,Ler-0 CENH3,Tanz-1 CENH3",
#                                 split = ","))
#controlNamesPlot <- unlist(strsplit("Col-0 input,Cvi-0 input,Ler-0 input,Tanz-1 input",
#                                    split = ","))
#ChIPColours <- unlist(strsplit("darkorange1,darkorchid1,forestgreen,dodgerblue1",
#                               split = ","))
#controlColours <- unlist(strsplit("darkorange1,darkorchid1,forestgreen,dodgerblue1",
#                                  split = ","))
...
ggsave(paste0(plotDir,
              ...
              "_avgProfiles_around",
              "_CEN180_ranLoc_CENAthila_nonCENAthila_Gypsy_",
