...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("Col-0_deepsignalDNAmeth_20kb_MappedOn_Col-0.ragtag_scaffolds_CpG,Col-0_deepsignalDNAmeth_20kb_MappedOn_Col-0.ragtag_scaffolds_CHG,Col-0_deepsignalDNAmeth_20kb_MappedOn_Col-0.ragtag_scaffolds_CHH",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("pancentromere/deepsignal_DNAmeth/Col-0.ragtag_scaffolds,pancentromere/deepsignal_DNAmeth/Col-0.ragtag_scaffolds,pancentromere/deepsignal_DNAmeth/Col-0.ragtag_scaffolds",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col-0 mCG,Col-0 mCHG,Col-0 mCHH",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("dodgerblue4,dodgerblue1,cyan2",
#                               split = ","))
#refbase <- "Col-0.ragtag_scaffolds"
...
ggsave(paste0(plotDir,
              ...
              "_avgProfiles_around",
              "_CEN180_ranLoc_CENAthila_nonCENAthila_Gypsy_in_", refbase, "_",
